...
<!--               <div class="brand-logo">
              ...
              <form class="pt-3">
                ...
                <div class="my-3">
                <button type="submit" class="btn btn-block btn-dark btn-lg font-weight-medium auth-form-btn" name="login">Login</button>
                ...
                <div class="text-center mt-4 font-weight-light">
                  Are you a Lawyer? <a href="lawyersregister.php" class="text-primary">Register</a>
                </div>
