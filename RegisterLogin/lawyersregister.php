          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <div class="form-group mb-3">
                ...
                <div class="input-group-prepend bg-transparent">
                  <span class="input-group-text bg-transparent border-right-0">
                    <i class="fa fa-solid fa-briefcase text-dark"></i>
                  </span>
                </div>
                <select class="form-control form-control-lg border-left-0" name="dept">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend bg-transparent">
                      <span class="input-group-text bg-transparent border-right-0">
                        <i class="fa fa-solid fa-image text-dark"></i>
                      </span>
                    </div>

                    <input type="file" class="form-control form-control-md border-left-2" id="customFile" name="l_img" /> 
                ...
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-dark btn-lg font-weight-medium auth-form-btn" name="lawyers_register">Register</button>
                </div>

                <div class="text-center mt-4 font-weight-light">
                  Are you a Customer? <a href="register.php" class="text-dark">Register</a>
                </div>
